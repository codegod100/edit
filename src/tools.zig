...
pub const definitions = [_]ToolDef{
    ...
    .{ .name = "replace_in_file", .description = "Replace text in a file. Large edits (>100 lines) require confirm=true.", .parameters_json = "{\"type\":\"object\",\"properties\":{\"path\":{\"type\":\"string\"},\"find\":{\"type\":\"string\"},\"replace\":{\"type\":\"string\"},\"all\":{\"type\":\"boolean\"},\"confirm\":{\"type\":\"boolean\"}},\"required\":[\"path\",\"find\",\"replace\",\"all\",\"confirm\"],\"additionalProperties\":false}" },
